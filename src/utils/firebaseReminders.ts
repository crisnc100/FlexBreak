...
export const sendLocalMotivationalMessage = async (): Promise<string> => {
  try {
    ...
    // Collection of motivational messages with emojis and energy
    const MOTIVATIONAL_MESSAGES = [
      {
        title: "🌟 Keep Going!",
        body: "Every stretch brings you closer to better flexibility!"
      },
      {
        title: "💎 Precious Progress!",
        body: "Every stretch is a gem in your wellness crown!"
      },
      {
        title: "🎨 Paint Your Progress!",
        body: "Each stretch adds color to your wellness canvas!"
      },
      {
        title: "🌈 Keep It Up!",
        body: "Regular stretching is the key to long-term wellness!"
      },
      {
        title: "🎯 Stay Consistent!",
        body: "Small steps lead to big improvements!"
      },
      {
        title: "🔥 On Fire!",
        body: "Your commitment to flexibility is inspiring!"
      },
      {
        title: "🎪 Flexibility Circus!",
        body: "You're the star performer in your wellness show!"
      },
      {
        title: "🌺 Bloom Where You Stretch!",
        body: "Growth happens one stretch at a time!"
      },
      {
        title: "🌙 Dream Stretcher!",
        body: "Turn your flexibility dreams into reality!"
      },
      {
        title: "🏆 Champion Mode!",
        body: "Your consistency deserves a gold medal!"
      },
      {
        title: "⚡ Power Up Break!",
        body: "Recharge your body and supercharge your day!"
      },
      {
        title: "🚀 Productivity Boost!",
        body: "Quick stretch = sharper focus and better performance!"
      },
      {
        title: "🎮 Level Up Time!",
        body: "Unlock your body's potential with a movement break!"
      },
      {
        title: "💪 Strength Builder!",
        body: "Every stretch makes you stronger and more resilient!"
      },
      {
        title: "🧘‍♀️ Mind-Body Reset!",
        body: "Stretch your way to mental clarity and peace!"
      },
      {
        title: "🎵 Move to the Beat!",
        body: "Your body is dancing to the rhythm of wellness!"
      },
      {
        title: "🌊 Flow State Incoming!",
        body: "Ride the wave of movement and find your flow!"
      },
      {
        title: "🔋 Battery Recharge!",
        body: "Low energy? Time to plug into the power of stretching!"
      },
      {
        title: "🎭 Performance Time!",
        body: "Your body is ready for its wellness performance!"
      },
      {
        title: "🌅 Fresh Start Energy!",
        body: "Every stretch is a sunrise for your muscles!"
      }
    ];
...
const scheduleProductionMotivationalMessages = async () => {
  try {
    ...
    // Collection of energizing motivational messages
    const MOTIVATIONAL_MESSAGES = [
      {
        title: "🌟 Keep Going!",
        body: "Every stretch brings you closer to better flexibility!"
      ...
      {
        title: "🎈 Lighten Up!",
        body: "Let stretching lift the weight off your shoulders!"
      },
      {
        title: "⭐ Star Quality Movement!",
        body: "You're shining bright with every stretch session!"
      },
      {
        title: "🎪 Amazing Flexibility!",
        body: "Step right up to the greatest stretch show on earth!"
      },
      {
        title: "🌟 Stellar Progress!",
        body: "You're reaching for the stars with every movement!"
      },
      {
        title: "🎨 Create Your Masterpiece!",
        body: "Paint a picture of health with bold movement strokes!"
      },
      {
        title: "🔮 Magic Moment!",
        body: "Transform tension into tranquility with the magic of stretching!"
      },
      {
        title: "🎯 Bullseye Wellness!",
        body: "You're hitting the target of total body care!"
      },
      {
        title: "🌈 Rainbow Connection!",
        body: "Bridge the gap between stress and serenity!"
      },
      {
        title: "🚀 Launch Sequence!",
        body: "3... 2... 1... Blast off to better flexibility!"
      },
      {
        title: "🎊 Celebration Time!",
        body: "Every stretch is worth celebrating - you're awesome!"
      }
    ];
