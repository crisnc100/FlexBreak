    ...
    <View style={[styles.section, { 
      ...
      <View style={styles.insightRow}>
        <View style={[styles.insightCard, { 
          backgroundColor: isDark || isSunset ? 'rgba(255,255,255,0.05)' : '#F5F5F5'
        }]}>
          <Text style={[styles.insightLabel, { color: isDark || isSunset ? theme.textSecondary : '#666' }]}>
            30-Day Activity
          </Text>
          <Text style={[styles.insightValue, { color: isDark || isSunset ? theme.accent : '#4CAF50' }]}>
            {getConsistencyPercentage(activeRoutineDays)}%
          </Text>
          <Text style={[styles.insightDescription, { color: isDark || isSunset ? theme.textSecondary : '#666' }]}>
